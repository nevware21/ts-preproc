...
const rollupConfigMainEntry = (srcPath, destPath, path, format, entryPoint = "merge-coverage.js", outputName = "coveragetools", bannerPrefix = undefined) => {
...
export default [
    rollupConfigMainEntry("build/es5/mod", "dist", "bin", "cjs", "cli/mergeCoverageCli.js", "merge-coverage", "#!/usr/bin/env node"),
];
