...
const rollupConfigMainEntry = (srcPath, destPath, path, format, entryPoint = "index.js", outputName = "preproc") => {
...
export default [
    rollupConfigMainEntry("build/es5/mod", "dist", "bin", "cjs", "cli/preProcCli.js", "ts-preproc"),
    rollupConfigMainEntry("build/es5/mod", "dist", "bin", "cjs", "cli/preProcRestoreCli.js", "ts-preproc-restore"),
