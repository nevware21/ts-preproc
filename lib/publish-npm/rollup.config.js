...
const rollupConfigMainEntry = (srcPath, destPath, path, format, entryPoint = "index.js", outputName = "publish-npm") => {
...
export default [
    rollupConfigMainEntry("build/es5/mod", "dist", "bin", "cjs", "cli/publishNpmCli.js", "publish-npm")
];
