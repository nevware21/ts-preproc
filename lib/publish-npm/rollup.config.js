...
const banner = [
    "/*!",
    ` * NevWare21 Solutions LLC - publish-npm, ${version}`,
...
const rollupConfigMainEntry = (srcPath, destPath, path, format, entryPoint = "index.js", outputName = "publish-npm", bannerPrefix = undefined) => {
...
export default [
    rollupConfigMainEntry("build/es5/mod", "dist", "bin", "cjs", "cli/publishNpmCli.js", "publish-npm", "#!/usr/bin/env node")
];
